...
import {createPosTargetShader, createAccShader, createVelShader, createPosShader} from './entangled-bubble-shaders.js';
...
function init() {
    console.log("Initializing Entangled Bubble...");
    initialized = true;
...
function setupGpuComputation() {
    ...
    console.log('GPU computation initialized - Bubble shape');
}
