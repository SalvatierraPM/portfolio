...
import {createPosTargetShader, createAccShader, createVelShader, createPosShader} from './entangled-hexagon-shaders.js';
...
function init() {
    console.log("Initializing Entangled Hexagon...");
    initialized = true;
...
function setupGpuComputation() {
    ...
    console.log('GPU computation initialized - Hexagon shape');
}
...
function setupInteraction() {
    ...
    document.getElementById('openPair').addEventListener('click', () => {
        ...
        window.open(
            'entangled-hexagon.html',
            'entangled-hexagon-pair',
